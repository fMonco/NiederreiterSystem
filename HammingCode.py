...
def createCheckMatrixHamming(r):
    ...
    print('\nCоздание проверочной матрицы')
    print(*transposeMatrix(result), sep='\n')
...
def transformationCheckSysMatrixHamming(checkMatrix):
    ...
    print('приведение порождающей матрицы к систематическому виду перестановкой столбцов', transposeMatrix(checkMatrix)) 
...
def createGenerSysMatrixHamming(checkSysMatrix):
    ...
    print("информационной подматрицы P", result)
    return result
